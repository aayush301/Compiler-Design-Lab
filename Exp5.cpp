// Write a program to convert NFA into an equivalent DFA
...
// Example-2
// vector<char> states = {'0', '1', '2'};
// vector<char> inputSymbols = {'a', 'b'};
// unordered_map<char, unordered_map<char, vector<char>>> transitionFn = {
// 	{'0', {{'a', {'0'}}, {'b', {'0','1'}}}},
// 	{'1', {{'a', {}}, {'b', {'2'}}}},
// 	{'2', {{'a', {}}, {'b', {}}}},
// };
// char startState = '0';
// vector<char> finalStates = {'2'};

// Example-3
// vector<char> states = {'0', '1', '2', '3'};
// vector<char> inputSymbols = {'a', 'b'};
// unordered_map<char, unordered_map<char, vector<char>>> transitionFn = {
// 	{'0', {{'a', {'0','1'}}, {'b', {'0'}}}},
// 	{'1', {{'a', {'2'}}, {'b', {'1'}}}},
